...
def _():
    ...
    return height, plot_correlated_data, weight
...
@app.cell
def _(np, plot_correlated_data):
    _X = np.linspace(1, 10, 100)
    _Y = -(np.linspace(1, 5, 100) + np.sin(_X) * 0.2)
    plot_correlated_data(_X, _Y)
    print(np.cov(_X, _Y))
    return
...
def _(np, plot_correlated_data):
    ...
    _X = np.linspace(1, 10, 1000) + randn(1000) * 2
    _Y = np.linspace(1, 5, 1000) + randn(1000)
    plot_correlated_data(_X, _Y)
    print(np.cov(_X, _Y))
    return (randn,)
...
@app.cell
def _(np, plot_correlated_data, randn):
    _X = randn(100000)
    _Y = randn(100000)
    plot_correlated_data(_X, _Y)
    print(np.cov(_X, _Y))
...
def _():
    ...
    mean = [2.0, 17.0]
    _cov = [[10.0, 0.0], [0.0, 4.0]]
    mkf_internal.plot_3d_covariance(mean, _cov)
    return (mkf_internal,)
...
@app.cell
def _(P, mu, multivariate_gaussian, x):
...
def _():
    ...
    P_1 = [[2, 0], [0, 6]]
    plot_covariance_ellipse((2, 7), P_1, fc='g', alpha=0.2, std=[1, 2, 3], title='|2 0|\n|0 6|')
    plt.gca().grid(b=False)
    return plot_covariance_ellipse, plt
...
@app.cell
def _(plot_covariance_ellipse, plt):
    x_1 = [2, 7]
    P_2 = [[2, 0], [0, 2]]
    plot_covariance_ellipse(x_1, P_2, fc='g', alpha=0.2, title='|2 0|\n|0 2|')
    plt.gca().grid(b=False)
    return
...
def _(plot_covariance_ellipse, plt):
    x_2 = [2, 7]
    P_3 = [[2, 0], [0, 6]]
    plot_covariance_ellipse(x_2, P_3, fc='g', alpha=0.2, title='|2 0|\n|0 6|')
    plt.gca().grid(b=False)
    return
...
def _(plot_covariance_ellipse):
    x_3 = [2, 7]
    P_4 = [[2, 1.2], [1.2, 2]]
    plot_covariance_ellipse(x_3, P_4, fc='g', alpha=0.2, title='|2 1.2|\n|1.2 2|')
    return
...
@app.cell
def _(cov_hw, height, np, plot_covariance_ellipse, plt, weight):
...
@app.cell
def _(np, plot_covariance_ellipse, plt):
    max_temp = [200, 250, 300, 400, 450, 500]
    lifespan = [10, 9.7, 5, 5.4, 4.3, 0.3]
    plt.scatter(max_temp, lifespan, s=80)
    _cov = np.cov(np.vstack((max_temp, lifespan)))
    plot_covariance_ellipse((np.mean(max_temp), np.mean(lifespan)), _cov, fc='g', alpha=0.2, axis_equal=False, std=2)
    plt.title('Engine Temperature vs Lifespan')
    plt.xlabel('Temperature (C)')
    plt.ylabel('Years')
    return lifespan, max_temp
...
@app.cell
def _(lifespan, max_temp, pearsonr):
...
def _(plot_covariance_ellipse, plt):
    P_5 = [[4, 3.9], [3.9, 4]]
    plot_covariance_ellipse((5, 10), P_5, ec='k', std=[1, 2, 3])
    plt.xlabel('X')
    plt.ylabel('Y')
    return
...
@app.cell
def _(P0, plot_covariance_ellipse):
    P1 = [[2, 1.9], [1.9, 2]]
    plot_covariance_ellipse((10, 10), P0, fc='y', alpha=0.6)
...
@app.cell
def _(P0, P1, plot_covariance_ellipse):
    ...
    return P2, multivariate_multiply
...
@app.cell
def _(P2, plot_covariance_ellipse):
    P3 = [[2, -1.9], [-1.9, 2.2]]
...
@app.cell
def _(P2, P3, multivariate_multiply, plot_covariance_ellipse):
    _P4 = multivariate_multiply((10, 10), P2, (10, 10), P3)[1]
    plot_covariance_ellipse((10, 10), P2, ec='k', fc='y', alpha=0.6)
    plot_covariance_ellipse((10, 10), P3, ec='k', fc='g', alpha=0.6)
    plot_covariance_ellipse((10, 10), _P4, ec='k', fc='b')
    return
...
@app.cell
def _(P0, multivariate_multiply, plot_covariance_ellipse):
    P1_1 = [[2, 0], [0, 0.2]]
    P2_1 = multivariate_multiply((10, 10), P0, (10, 10), P1_1)[1]
    plot_covariance_ellipse((10, 10), P0, ec='k', fc='y', alpha=0.2)
    plot_covariance_ellipse((10, 10), P1_1, ec='k', fc='g', alpha=0.6)
    plot_covariance_ellipse((10, 10), P2_1, ec='k', fc='b')
    return (P2_1,)
...
@app.cell
def _(P2_1, multivariate_multiply, plot_covariance_ellipse):
    P3_1 = [[2, -1.9], [-1.9, 2.2]]
    _P4 = multivariate_multiply((10, 10), P2_1, (10, 10), P3_1)[1]
    plot_covariance_ellipse((10, 10), P2_1, ec='k', fc='y', alpha=0.2)
    plot_covariance_ellipse((10, 10), P3_1, ec='k', fc='g', alpha=0.6)
    plot_covariance_ellipse((10, 10), _P4, ec='k', fc='b')
    return
...
@app.cell
def _(P2_1, multivariate_multiply, plot_covariance_ellipse, plt):
    P5 = multivariate_multiply((10, 10), P2_1, (10.1, 9.97), P2_1)
    plot_covariance_ellipse((10, 10), P2_1, ec='k', fc='y', alpha=0.2)
    plot_covariance_ellipse((10.1, 9.97), P2_1, ec='k', fc='g', alpha=0.6)
...
def _(np):
    ...
    sample = np.random.multivariate_normal(mu_1, C, size=1000)
    return C, mu_1, plot_3d_covariance, sample
...
@app.cell
def _(C, mu_1, plot_3d_covariance, sample):
    ax = plot_3d_covariance(mu_1, C, alpha=0.4, std=3, limit_xyz=True)
